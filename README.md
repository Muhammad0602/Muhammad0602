...
- 🔭 I am a Full-stack web developer with a love for JavaScript, React, and Redux. I play chess and learn new languages in my spare time. Open to new opportunities.
- 📫 How to reach me:
...
const muhammadDavlatov = {
  ...
  pronouns: ["he", "him"],
  code: [JavaScript, React, Redux, HTML/CSS, Ruby, Ruby on Rails, SQL],
